    ...
    <div class="{{$containerNav}}">
      ...
      <div class="navbar-brand app-brand demo d-none d-xl-flex py-0 me-4">
        <a href="{{url('/')}}" class="app-brand-link gap-2">
          ...
          <span style="font-family:fantasy; font-size:20px; margin-left:5px;">Kehadiran</span>
        </a>
          ...
          <li class="nav-item navbar-dropdown dropdown-user dropdown">
            <a class="nav-link dropdown-toggle hide-arrow p-0" href="javascript:void(0);" data-bs-toggle="dropdown">
              <div class="avatar avatar-online">
                  <img src="{{ asset(Auth::user()->avatar ? 'uploads/' . Auth::user()->avatar : 'assets/img/avatars/null.jpg') }}" alt class="w-px-40 h-auto rounded-circle">
              </div>
            </a>
            <ul class="dropdown-menu dropdown-menu-end mt-3 py-2">
              ...
              @if(Auth::check())
                ...
                <li>
                  <a class="dropdown-item" href="javascript:void(0);">
                    <i class='mdi mdi-power me-1 mdi-20px'></i>
                  <button type="submit" class="btn btn-sm btn-transparent" style="border:none; box-shadow:none;">Logout</button>                    
                  </a>
                </li>
                </form>
              @endif
